...
import SendEmailWhenProductIsCreatedHandler from "../product/handler/send-email-when-product-id-created.handler";
import ProductCreatedEvent from "../product/product-created.event";
import PrintConsoleLogWhenCustomerCreatedHandler
    from "../customer/handler/print-console-log-when-customer-created.handler";
import PrintOtherConsoleLogWhenCustomerCreatedHandler
    from "../customer/handler/print-other-console-log-when-customer-created.handler";
import CustomerCreatedEvent from "../customer/customer-created.event";
import PrintConsoleLogWhenCustomerAddressHasChanged
    from "../customer/handler/print-console-log-when-customer-address-has-changed";
